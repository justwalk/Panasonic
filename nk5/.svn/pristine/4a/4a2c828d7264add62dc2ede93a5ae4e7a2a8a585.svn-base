    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            function (oSettings, aData, iDataIndex) {
                ...
                var dStartDate1 = from.datepicker("getDate");

                var dEndDate1= to.datepicker("getDate");
                ...
                var dEndDate=null;
                    ...
                    if(dStartDate1!=null){
                        var seperator1 = "/";
                        var month = dStartDate1.getMonth() + 1;
                        if(month>0&&month<10){
                             month = "0" + month;
                        }
                        var strdate=dStartDate1.getDate();
                        if(strdate>0&&strdate<10){
                            strdate = "0" + strdate;
                        }
                     dStartDate=  dStartDate1.getFullYear() +seperator1 +month + seperator1 + strdate; 
                      ...
                      if(dEndDate1!=null){
                        var seperator2 = "/";
                        var month = dEndDate1.getMonth() + 1;
                        if(month>0&&month<10){
                             month = "0" + month;
                        }
                        var strdate=dEndDate1.getDate();
                        if(strdate>0&&strdate<10){
                            strdate = "0" + strdate;
                        }
                     dEndDate=  dEndDate1.getFullYear() + seperator2 +month + seperator2 + strdate;
                    }
                     //alert(index);
...
;
                ...
                try {
                    ...
                    if (aData[_fnColumnIndex(index)] == null || aData[_fnColumnIndex(index)] == ""){
                        return false;
                           ...
                           dCellDate =  $.trim(aData[_fnColumnIndex(index)].split(' ')[0]);
                           //alert(dCellDate);
                    }
               ...
               //alert("dEndDate"+Date.parse(dEndDate));

                if (dCellDate == null)
                    return false;
        

                if (dStartDate == null &&  Date.parse(dCellDate) <= Date.parse(dEndDate)) {
                    return true;
                }
                else if (Date.parse(dStartDate) <= Date.parse(dCellDate) && dEndDate == null) {
                    return true;
                }
                else if (Date.parse(dStartDate) <= Date.parse(dCellDate) && Date.parse(dCellDate) <= Date.parse(dEndDate)) {
                    return true;
                }
                return false;
            }
