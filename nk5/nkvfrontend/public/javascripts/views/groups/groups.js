define([
  ...
  'bootstrapDatatables'
], function($, _, Backbone, RSVP, GroupView, groupsTemplate, ComputersCollection, ComputersView, ComputerCommands, ContextCommands, AddGroupView,ComputerFormT,Computer,Menus){
    var GroupsView = Backbone.View.extend({
        ...
        selectRefresh:function(e){
           ...
           // //this.render();
           //  App.vent.trigger('computers:render');
           //this.computersView.render();
		        Backbone.history.loadUrl();
          } , 
        render: function() {
          var self = this;
          var options;
          if(self.group_id == 0){
            options = '<option selected="selected" value="0">All</option><option value="-1">Template</option>';
          }else if(self.group_id == -1){
            options = '<option value="0">All</option><option selected="selected" value="-1">Template</option>';
          }else{
            options = '<option value="0">All</option><option value="-1">Template</option>';
          }
